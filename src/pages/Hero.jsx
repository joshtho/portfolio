...
import PortfolioPage from "@/pages/About";
      ...
      <main className="bg-[#020617] text-white min-h-screen">
        ...
        >
          ...
          >
            ...
            <div className="w-full lg:w-1/2 mb-12 animate__animated animate__fadeInLeft relative">
              {/* Decorative blurs */}
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Full-Stack Developer | Experienced Collaborator | Natural Problem Solver
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <button
                  onClick={() => window.open(`${import.meta.env.BASE_URL}developer-resume.pdf`, '_blank')}
              ...
              <div className="hidden lg:block absolute left-[5.5rem] top-[2.3rem] animate-float-slow">
                <div className="px-4 py-2 rounded-lg bg-purple-500/10 backdrop-blur-sm border border-purple-500/20 text-purple-400">
                  <i className="fas fa-wand-magic-sparkles"></i>&nbsp;&nbsp;Collaborative
                </div>
              </div>
